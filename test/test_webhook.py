...
def test_it_updates_and_returns_204_if_a_profile_is_found(
    test_client: FlaskClient, webhook_payload: str, commit: Callable[[], None]
) -> None:
...
def test_it_returns_404_if_a_profile_is_not_found(
    test_client: FlaskClient, webhook_payload: str
) -> None:
    response = test_client.post("/orcid-webhook/{}".format(webhook_payload))
...
def test_it_returns_503_if_an_access_token_is_rejected(
    profile: Profile,
...
def test_it_removes_token_if_it_was_rejected(
    profile: Profile,
    test_client: FlaskClient,
    orcid_token: OrcidToken,
...
def test_it_returns_500_on_an_orcid_error(
    profile: Profile,
    orcid_token: OrcidToken,
    test_client: FlaskClient,
    webhook_payload: str,
