...
def test_it_gets_a_record(orcid_client: OrcidClient):
    with requests_mock.Mocker() as mocker:
        ...
        record = orcid_client.get_record(
            "0000-0002-1825-0097", "1/fFAGRNJru1FTz70BzhT3Zg"
        )
...
def test_it_sets_a_webhook(orcid_client: OrcidClient):
    with requests_mock.Mocker() as mocker:
        mocker.put(
            "http://www.example.com/api/0000-0002-1825-0097/webhook/"
