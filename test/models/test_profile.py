...
def test_it_can_get_current_affiliations(tomorrow, yesterday):
    ...
    affiliation1 = Affiliation(
        "1", address=address, organisation="Org", starts=yesterday
    )
    affiliation2 = Affiliation(
        "2", address=address, organisation="Org", starts=yesterday, ends=tomorrow
    )
    affiliation3 = Affiliation(
        "3", address=address, organisation="Org", starts=tomorrow
    )
    affiliation4 = Affiliation(
        "4", address=address, organisation="Org", starts=yesterday, ends=yesterday
    )
...
def test_it_can_get_all_non_restricted_affiliations(yesterday):
    ...
    affiliation2 = Affiliation(
        "2", address=address, organisation="Org", starts=yesterday, restricted=True
    )
    affiliation3 = Affiliation(
        "3", address=address, organisation="Org", starts=yesterday
    )
